...
#include "i_vehicle_search_dialog.h"

///////////////////////////////////////////////////////////////////////////

IVehicleSearchDialog::IVehicleSearchDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	m_button_searchSubmitVehicle->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( IVehicleSearchDialog::OnSearchSubmitVehicleButtonClicked ), NULL, this );
	m_button_cancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( IVehicleSearchDialog::OnCancel ), NULL, this );
}

IVehicleSearchDialog::~IVehicleSearchDialog()
{
	// Disconnect Events
	m_button_searchSubmitVehicle->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( IVehicleSearchDialog::OnSearchSubmitVehicleButtonClicked ), NULL, this );
	m_button_cancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( IVehicleSearchDialog::OnCancel ), NULL, this );
