...
///////////////////////////////////////////////////////////////////////////////
/// Class IVehicleSearchDialog
///////////////////////////////////////////////////////////////////////////////
class IVehicleSearchDialog : public wxDialog
{
	private:
	...
	public:
		...
		IVehicleSearchDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Wyszukiwanie pojazdu"), const wxPoint& pos = wxPoint( -1,-1 ), const wxSize& size = wxSize( 550,800 ), long style = wxDEFAULT_DIALOG_STYLE );
		~IVehicleSearchDialog();
